...
router.put("/api/overall_attendance_record/:id", (req, res) => {
  ...
  const query = `
    ...
    totalRenderedTimeMorning = ?, totalTardAM = ?, 
    totalRenderedTimeAfternoon = ?, totalTardPM = ?, 
    totalRenderedHonorarium = ?, totalTardHR = ?, 
    totalRenderedServiceCredit = ?, totalTardSC = ?, 
    totalRenderedOvertime = ?, totalTardOT = ?, overallRenderedTime = ? 
    WHERE id = ?;
  `;
