...
<Grid container spacing={2} sx={{ marginBottom: 3 }}>
    ...
    <Grid item xs={12} sm={6} md={4} lg={3}>
        ...
        <Box sx={{ marginTop: 3, marginBottom: 3 }}>
              ...
              variant="contained"
              style={{ backgroundColor: '#00072D', color: 'white' }}
              startIcon={<AddIcon />}
            ...
            <Box sx={{ marginBottom: 3 }}>
                ...
                <   Box key={person.id} sx={{ marginBottom: 3, padding: 3, border: '1px solid #400000 ', borderRadius: 1, backgroundColor: '#f9f9f9' }}>
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'flex-end' }}>
                            {editPerson && editPerson.id === person.id ? (
                                <>
                                    <Button onClick={updateItem} variant="contained" color="primary" sx={{ marginRight: 2, backgroundColor: '#00072D' }} startIcon={<SaveIcon />}>Save</Button>
                                    <Button onClick={() => setEditPerson(null)} variant="contained" color="secondary" sx={{ marginRight: 2, backgroundColor: '#800000' }} startIcon={<CancelIcon />}>Cancel</Button>
                                </>
                            ) : (
                                <>
                                    <Button onClick={() => setEditPerson(person)} variant="contained" color="primary" sx={{ marginRight: 2, backgroundColor: '#00072D' }} startIcon={<EditIcon />}>Edit</Button>
                                    <Button onClick={() => deleteItem(person.id)} variant="contained" color="secondary" sx={{ marginRight: 2, backgroundColor: '#800000' }} startIcon={<DeleteIcon />}>Delete</Button>
                                </>
                            )}
                        </Box>
                    </Box>
