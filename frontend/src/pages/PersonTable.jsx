...
const PersonalTable = () => {
  ...
  const addItem = async () => {
    ...
    if (
      ...
      (typeof civilStatus === "string" && civilStatus.trim() === "") ||
      (typeof heightM === "string" && heightM.trim() === "") ||
      (typeof weightKg === "string" && weightKg.trim() === "") ||
      (typeof bloodType === "string" && bloodType.trim() === "") ||
      (typeof gsisNum === "string" && gsisNum.trim() === "") ||
      (typeof pagibigNum === "string" && pagibigNum.trim() === "") ||
      (typeof philhealthNum === "string" && philhealthNum.trim() === "") ||
      (typeof sssNum === "string" && sssNum.trim() === "") ||
      (typeof tinNum === "string" && tinNum.trim() === "") ||
      (typeof agencyEmployeeNum === "string" &&
        agencyEmployeeNum.trim() === "") ||
      (typeof houseBlockLotNum === "string" &&
        houseBlockLotNum.trim() === "") ||
      (typeof streetName === "string" && streetName.trim() === "") ||
      (typeof subdivisionOrVillage === "string" &&
        subdivisionOrVillage.trim() === "") ||
      (typeof barangayName === "string" && barangayName.trim() === "") ||
      (typeof cityOrMunicipality === "string" &&
      ...
      (typeof mobileNum === "string" && mobileNum.trim() === "") ||
      (typeof emailAddress === "string" && emailAddress.trim() === "") ||
      (typeof spouseFirstName === "string" && spouseFirstName.trim() === "") ||
      (typeof spouseMiddleName === "string" &&
        spouseMiddleName.trim() === "") ||
      (typeof spouseLastName === "string" && spouseLastName.trim() === "") ||
      (typeof spouseNameExtension === "string" &&
        spouseNameExtension.trim() === "") ||
      (typeof spouseOccupation === "string" &&
        spouseOccupation.trim() === "") ||
      (typeof spouseEmployerBusinessName === "string" &&
        spouseEmployerBusinessName.trim() === "") ||
      (typeof spouseBusinessAddress === "string" &&
        spouseBusinessAddress.trim() === "") ||
      (typeof spouseTelephone === "string" && spouseTelephone.trim() === "") ||
      (typeof fatherFirstName === "string" && fatherFirstName.trim() === "") ||
      (typeof fatherMiddleName === "string" &&
        fatherMiddleName.trim() === "") ||
      (typeof fatherLastName === "string" && fatherLastName.trim() === "") ||
      (typeof fatherNameExtension === "string" &&
        fatherNameExtension.trim() === "") ||
      (typeof motherMaidenFirstName === "string" &&
        motherMaidenFirstName.trim() === "") ||
      (typeof motherMaidenMiddleName === "string" &&
        motherMaidenMiddleName.trim() === "") ||
      (typeof motherMaidenLastName === "string" &&
        motherMaidenLastName.trim() === "") ||
      (typeof elementaryNameOfSchool === "string" &&
        elementaryNameOfSchool.trim() === "") ||
      (typeof elementaryDegree === "string" &&
        elementaryDegree.trim() === "") ||
      (typeof elementaryPeriodFrom === "string" &&
        elementaryPeriodFrom.trim() === "") ||
      (typeof elementaryPeriodTo === "string" &&
        elementaryPeriodTo.trim() === "") ||
      (typeof elementaryHighestAttained === "string" &&
        elementaryHighestAttained.trim() === "") ||
      (typeof elementaryYearGraduated === "string" &&
        elementaryYearGraduated.trim() === "") ||
      (typeof elementaryScholarshipAcademicHonorsReceived === "string" &&
        elementaryScholarshipAcademicHonorsReceived.trim() === "") ||
      (typeof secondaryNameOfSchool === "string" &&
        secondaryNameOfSchool.trim() === "") ||
      (typeof secondaryDegree === "string" && secondaryDegree.trim() === "") ||
      (typeof secondaryPeriodFrom === "string" &&
        secondaryPeriodFrom.trim() === "") ||
      (typeof secondaryPeriodTo === "string" &&
        secondaryPeriodTo.trim() === "") ||
      (typeof secondaryHighestAttained === "string" &&
        secondaryHighestAttained.trim() === "") ||
      (typeof secondaryYearGraduated === "string" &&
        secondaryYearGraduated.trim() === "") ||
      (typeof secondaryScholarshipAcademicHonorsReceived === "string" &&
