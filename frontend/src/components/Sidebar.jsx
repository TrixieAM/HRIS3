      ...
      <List>
            ...
            <Collapse in={open} timeout="auto" unmountOnExit>
              <List component="div" disablePadding sx={{ pl: 4 }}>
                ...
                <ListItem
                  ...
                  component={Link} 
                  to= '/childreninfo' 
                  sx={{ color: 'black', bgcolor: selectedItem === 'childreninfo' ? '#6c0b19' : 'inherit', '&:hover': { bgcolor: '#6c0b19', color: 'white' }, color: selectedItem === 'childreninfo' ? 'white' : 'inherit',
                  }}
                  onClick={() => handleItemClick('childreninfo')} 
                >
                  <ListItemIcon sx={{ marginRight: '-1rem' }}>
                    <ChildFriendlyRounded />
                  </ListItemIcon>
                ...
                <ListItem 
                  ...
                  component={Link} 
                  to= '/otherskills' 
                  sx={{ color: 'black', bgcolor: selectedItem === 'otherskills' ? '#6c0b19' : 'inherit', '&:hover': { bgcolor: '#6c0b19', color: 'white' }, color: selectedItem === 'otherskills' ? 'white' : 'inherit',
                  }}
                  onClick={() => handleItemClick('otherskills')} 
                  >
                  <ListItemIcon sx={{ marginRight: '-1rem' }}>
                    <ChildFriendlyRounded />
                  </ListItemIcon>
        ...
        <List>
          <ListItem 
                  ...
                  component={Link} 
                  to= '/pdsfile' 
                  sx={{ color: 'black', bgcolor: selectedItem === 'pdsfile' ? '#6c0b19' : 'inherit', '&:hover': { bgcolor: '#6c0b19', color: 'white' }, color: selectedItem === 'pdsfile' ? 'white' : 'inherit',
                  }}
                  onClick={() => handleItemClick('pdsfile')} 
                  >
            <ListItemIcon sx={{ marginRight: '-1rem' }}>
              <FileCopy />
            </ListItemIcon>
