                    ...
                    <AppBar position="fixed" sx={{ zIndex: (theme) => theme.zIndex.drawer + 1, bgcolor: settings.header_color || 'primary' }} className='no-print'>
                        <Toolbar>
                            {settings.logo_url && (
                                <img
                                    ...
                                    alt="Logo"
                                    style={{ height: '50px', padding: '10px 0', marginRight: '20px' }}
                                />
                            )}
                        ...
                        >
                            ...
                            <List>
                                ...
                                <ListItem button component={Link} sx={{ color: 'black' }} to="/home">
                                    <ListItemIcon><House sx={{fontSize: 29, marginLeft: '-6%'}}/></ListItemIcon>
                                ...
                                <Collapse in={open} timeout="auto" unmountOnExit>
                                    <List component="div" disablePadding sx={{ pl: 4 }}>
                                        <ListItem button component={Link} to="/personalinfo" sx={{ color: 'black' }}>
                                            <ListItemIcon sx={{ marginRight: '-1rem' }}><ChildFriendlyRounded /></ListItemIcon>
                                ...
                                <Collapse in={open} timeout="auto" unmountOnExit>
                                    <List component="div" disablePadding sx={{ pl: 4 }}>
                                        <ListItem button component={Link} to="/college" sx={{ color: 'black' }}>
                                            <ListItemIcon sx={{ marginRight: '-1rem' }}><School /></ListItemIcon>
                                ...
                                <Collapse in={open} timeout="auto" unmountOnExit>
                                    <List component="div" disablePadding sx={{ pl: 4 }}>
                                        <ListItem button component={Link} to="/vocational" sx={{ color: 'black' }}>
                                            <ListItemIcon sx={{ marginRight: '-1rem' }}><Streetview /></ListItemIcon>
                                ...
                                <Collapse in={open} timeout="auto" unmountOnExit>
                                    <List component="div" disablePadding sx={{ pl: 4 }}>
                                        <ListItem button component={Link} to="/learningdev" sx={{ color: 'black' }}>
                                            <ListItemIcon sx={{ marginRight: '-1rem' }}><PsychologyIcon /></ListItemIcon>
                                ...
                                <Collapse in={open} timeout="auto" unmountOnExit>
                                    <List component="div" disablePadding sx={{ pl: 4 }}>
                                        <ListItem button component={Link} to="/voluntarywork" sx={{ color: 'black' }}>
                                            <ListItemIcon sx={{ marginRight: '-1rem' }}><SportsKabaddi /></ListItemIcon>
                                ...
                                <Collapse in={open} timeout="auto" unmountOnExit>
                                    <List component="div" disablePadding sx={{ pl: 4 }}>
                                        <ListItem button component={Link} to="/eligibility" sx={{ color: 'black' }}>
                                            <ListItemIcon sx={{ marginRight: '-1rem' }}><BadgeRounded /></ListItemIcon>
                        ...
                        <Box component="main" sx={{ flexGrow: 1, bgcolor: 'background.default', p: 3, marginLeft: `${drawerWidth}px` }}>
                            ...
                            <Routes >
                                ...
                                <Route path="/childreninfo" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><ChildrenInfo /></ProtectedRoute>} />
                                <Route path="/voluntarywork" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><VoluntaryWork /></ProtectedRoute>} />
                                <Route path="/learningdev" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><LearningAndDevelopment /></ProtectedRoute>} />
                                <Route path="/eligibility" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><Eligibility /></ProtectedRoute>} />
                                <Route path="/college" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><College /></ProtectedRoute>} />
                                <Route path="/vocational" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><Vocational /></ProtectedRoute>} />
                                <Route path="/workexperience" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><WorkExperience /></ProtectedRoute> } />
                                <Route path="/personalinfo" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><PersonalTable /></ProtectedRoute> } />
                                <Route path="/otherskills" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><OtherSkills /></ProtectedRoute> } />
                                <Route path="/settings" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><SettingsForm onUpdate={fetchSettings} /></ProtectedRoute>} />
                                <Route path="/view_attendance" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><ViewAttendanceRecord /></ProtectedRoute> } />
                                <Route path="/search_attendance" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><AttendanceSearch /></ProtectedRoute> } />
                                <Route path="/daily_time_record" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><DailyTimeRecord /></ProtectedRoute> } />
                                <Route path="/daily_time_record_faculty" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><DailyTimeRecordFaculty/></ProtectedRoute> } />
                                <Route path="/attendance_form" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><AttendanceForm /></ProtectedRoute> } />
                                <Route path="/attendance_module" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><AttendanceModule /></ProtectedRoute> } />
                                <Route path="/attendance_summary" element={<ProtectedRoute allowedRoles={['administrator', 'superadmin']}><OverallAttendancePage/></ProtectedRoute> } />
                                <Route path="/pdsfile" element={<ProtectedRoute allowedRoles={['staff','administrator', 'superadmin']}><PDSFileSelector /></ProtectedRoute>} />
                                <Route path="/pds1" element={<ProtectedRoute allowedRoles={['staff','administrator', 'superadmin']}><PDS1 /></ProtectedRoute>} />
                                <Route path="/pds2" element={<ProtectedRoute allowedRoles={['staff','administrator', 'superadmin']}><PDS2 /></ProtectedRoute>} />
                                <Route path="/pds3" element={<ProtectedRoute allowedRoles={['staff','administrator', 'superadmin']}><PDS3 /></ProtectedRoute>} />
                                <Route path="/pds4" element={<ProtectedRoute allowedRoles={['staff','administrator', 'superadmin']}><PDS4 /></ProtectedRoute>} />
